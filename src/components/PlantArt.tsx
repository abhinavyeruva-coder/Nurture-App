...
/**
 * The plant itself (no pot), per type — kept separate from {@link Pot} so the
 * Home reveal can grow the plant out of the soil while the pot stays put.
 * Coordinates share the `0 0 64 66` viewBox so picker + Home art match exactly.
 */
